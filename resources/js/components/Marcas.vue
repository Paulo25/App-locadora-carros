                ...
                <card-component titulo="Relação de marcas">
                    ...
                    <template v-slot:rodape>
                        <div class="row">
                            ...
                            <div class="col">
                                <button type="botton" class="btn btn-primary btn-sm float-end" data-bs-toggle="modal" data-bs-target="#modalMarca">Adicionar</button>
                            </div>
                        </div>
                    </template>
                </card-component>
  ...
  components: { Paginate },
        ...
        methods: {
            ...
            carregarLista() {
                ...
                .catch(errors => {
                    console.log(errors);
                    this.marcas.data = []; // Define as empty array on error
                });
            },
            carregarImagem(e) {
